...
<template>
    <div class="dark:bg-zinc-900 bg-white p-10 shadow rounded-md flex">
        <div class="w-1/4 border-r dark:border-white border-zinc-400 pr-10 flex flex-col items-center gap-12">
